...
\begin{figure}[tb]
  \begin{center}
    \includegraphics[width=1.0\columnwidth]{figure1-system.pdf}
    \vspace{-2.0ex}
...
\begin{figure}[tb]
  \begin{center}
    \includegraphics[height=0.125\paperheight, width=0.9\columnwidth]{figure2-standard_pseudo_costs.pdf}
    \vspace{-2.0ex}
