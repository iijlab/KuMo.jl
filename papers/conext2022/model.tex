...
A simple system configuration with 2 datacenters and 2
...
type of resoures have a priority for a specific service.
...
$f'(\rho) = f(\rho + \Delta)$.
Similarly, an {\bf economy service} can be made by raising the target
load.
...
For the total load in the bottom plot, the load of n2 and n3 are
normalized to match the quantity of n0 and n1 because of the
...
In the second wave, the cost function of n0 is manipulated to reduce
...
user0: cycle: 180  peak:1.2 interactve:data-intensive=
user1: cycle: 135  peak:1.0 
