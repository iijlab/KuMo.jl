%\def \Comments{} % uncomment to have old (red) and new (blue) text side by side
\def \NewInsteadOfOld{} % (iff previous line is commented) comment for old text only, uncomment for new text only 
