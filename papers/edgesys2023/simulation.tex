...
Figure\ref{fig:edge} shows a simple scenario in which
flocks of drones move over 3 edge nodes.
A flock of 10 drones start arriving at edge 1.
The flock moves to edge 2, and then, to edge 3.
At time 15, another flock of 10 drones arrive.

\begin{figure}[tb]
  \begin{center}
    \includegraphics[width=1.0\columnwidth]{figure-edge.pdf}
    \vspace{-2.0ex}
    \caption{Flocks of drone --- edge scenario placeholder}
    \Description{Flocks of drone --- edge scenario placeholder}
    \label{fig:edge}
  \end{center}
\end{figure}
