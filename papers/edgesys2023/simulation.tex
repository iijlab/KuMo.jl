...
With the constant costs, each drone is assigned to the nearest node. In the other cases, the load of each node does not go up beyound $.75$, with the difference in the assignment of the remaining load.
...
This behavior leads to the stability in turbulence with convex costs.
