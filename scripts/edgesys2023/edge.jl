...
# all
p2 = plot(
    p_flat_flat2, p_monotonic_monotonic2, p_convex_monotonic2;
    layout=(3, 1),
    title=["(a) constant pseudo-costs" "(b) monotonic pseudo-costs" "(c) convex pseudo-costs"],
